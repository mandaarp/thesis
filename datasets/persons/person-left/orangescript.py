...
def main():
  ...
  if len(sys.argv) is 3:
    ...
    whole_set = False
  exp = LoadExperiment(ifname)
  train_table = MakeOrangeTableFromExperiment(exp.classes, exp.train_features, exp.train_images,whole_set)
  train_table.save(train_ofname)
  test_table = MakeOrangeTableFromExperiment(exp.classes, exp.test_features, exp.test_images,whole_set)
